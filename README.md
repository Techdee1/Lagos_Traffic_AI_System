...
YOLOv8 Detection - Detects base vehicle classes (car, motorcycle, bus, truck)

Lagos-Specific Classification:
...
IoU Tracking - Tracks vehicles across frames to count each unique vehicle once
...
Tailwind CSS
📧 Contact
Akeem Jr Odebiyi (Techdee)

Project Link: https://github.com/Techdee1/Lagos_Traffic_AI_System
